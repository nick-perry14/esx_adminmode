...
Config.enable_ban_json = false -- http://<server-ip>:<server-port>/esx_adminmode/bans.json
Config.enable_warning_json = false -- http://<server-ip>:<server-port>/esx_adminmode/warnings.json
